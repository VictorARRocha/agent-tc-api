...
def main() -> int:
    ...
    import_parser.add_argument("--backend", choices=["sqlite", "postgres"], default="sqlite")
    import_parser.add_argument("--dry-run", action="store_true", help="Planeja sem escrever no backend.")
