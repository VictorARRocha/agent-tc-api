...
- Importacao da rodagem: `PythonRodagem/run_agent_tc_python.ps1`, `PythonRodagem/cli/agent_tc_ingest.py`, `PythonRodagem/agent_tc_core/api_repository.py`.
- API/dados no dashboard: `API/run_agent_tc_api.ps1`, `PythonRodagem/cli/agent_tc_api.py`, `PythonRodagem/agent_tc_core/api_server.py`, `PythonRodagem/agent_tc_core/postgres_repository.py`.
- Storage/evidencias: `PythonRodagem/agent_tc_core/storage.py`, `AGENT_TC_STORAGE_ROOT`, endpoint `/files/...`.
- Jenkins/reexecucao/cancelamento: `JenkinsBridge/jenkins_bridge.py`, endpoints `/bridge/rerun-requests/...`.
- Auth/login/admin: `PythonRodagem/agent_tc_core/local_auth.py`, tabelas `agent_tc_auth_*`, tela admin do dashboard.
- Agrupamento IA: `PythonRodagem/agent_tc_core/ai_grouping.py`, `AGENT_TC_AUTH_BACKEND=local`, token retornado por `/auth/login`.
...
- `API/deploy/d01/DEPLOY_D01_DOCKER.md`
- `API/deploy/d01/docker-compose.d01.yml`
- `API/deploy/d01/docker.env.example`
- `PythonRodagem/.env.example`
